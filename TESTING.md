...
- https://validator.w3.org/nu/?doc=https%3A%2F%2FJesseRoss001.github.io%2FCommunity-Center%2Findex.html
...
| --- | --- | --- | --- |
| Home | [W3C](https://validator.w3.org/nu/?doc=https%3A%2F%2FJesseRoss001.github.io%2FCommunity-Center%2Findex.html) | ![screenshot](documentation/html-validation-home.png) | Section lacks header h2-h6 warning |
| Contact | [W3C](https://validator.w3.org/nu/?doc=https%3A%2F%2FJesseRoss001.github.io%2FCommunity-Center%2Fcontact.html) | ![screenshot](documentation/html-validation-contact.png) | obsolete iframe warnings |
| Quiz | [W3C](https://validator.w3.org/nu/?doc=https%3A%2F%2FJesseRoss001.github.io%2FCommunity-Center%2Fquiz.html) | ![screenshot](documentation/html-validation-quiz.png) | Pass: No Errors |
...
- https://jigsaw.w3.org/css-validator/validator?uri=https%3A%2F%2FJesseRoss001.github.io%2FCommunity-Center
...
| --- | --- | --- | --- |
| style.css | [Jigsaw](https://jigsaw.w3.org/css-validator/validator?uri=https%3A%2F%2FJesseRoss001.github.io%2FCommunity-Center) | ![screenshot](documentation/css-validation-style.png) | Pass: No Errors |
...
| --- | --- | --- | --- |
| run.py | [PEP8 CI](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/JesseRoss001/community-center/main/run.py) | ![screenshot](documentation/py-validation-run.png) | W291 trailing whitespace |
| settings.py | [PEP8 CI](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/JesseRoss001/community-center/main/boutique-ado/settings.py) | ![screenshot](documentation/py-validation-settings.png) | E501 line too long |
| Blog views.py | [PEP8 CI](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/JesseRoss001/community-center/main/blog/views.py) | ![screenshot](documentation/py-validation-blog-views.png) | Pass: No Errors |
| Checkout urls.py | [PEP8 CI](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/JesseRoss001/community-center/main/checkout/urls.py) | ![screenshot](documentation/py-validation-checkout-urls.png) | W292 no newline at end of file |
| Profiles models.py | [PEP8 CI](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/JesseRoss001/community-center/main/profiles/models.py) | ![screenshot](documentation/py-validation-profiles-models.png) | Pass: No Errors |
...
Alternatively, use this link: https://github.com/JesseRoss001/Community-Center/issues
...
All previously closed/fixed bugs can be tracked [here](https://github.com/JesseRoss001/Community-Center/issues?q=is%3Aissue+is%3Aclosed).

| Bug | Status |
| --- | --- |
| [JS Uncaught ReferenceError: `foobar` is undefined/not defined](https://github.com/JesseRoss001/Community-Center/issues/1) | Closed |
| [Python `'ModuleNotFoundError'` when trying to import module from imported package](https://github.com/JesseRoss001/Community-Center/issues/2) | Closed |
| [Django `TemplateDoesNotExist` at /appname/path appname/template_name.html](https://github.com/JesseRoss001/Community-Center/issues/3) | Closed |

**Open Issues**

Any remaining open issues can be tracked [here](https://github.com/JesseRoss001/Community-Center/issues).

| Bug | Status |
| --- | --- |
| [JS `'let'` or `'const'` or `'template literal syntax'` or `'arrow function syntax (=>)'` is available in ES6 (use `'esversion: 11'`) or Mozilla JS extensions (use moz).](https://github.com/JesseRoss001/Community-Center/issues/4) | Open |
| [Python `E501 line too long` (93 > 79 characters)](https://github.com/JesseRoss001/Community-Center/issues/5) | Open |
